                ...
                <div class="bg-gray-100 border-b px-4 py-4 sm:py-6 rounded-t-lg">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        <h2 class="text-lg sm:text-xl font-bold text-gray-800 flex items-center gap-2">
                            ...
                            Student: <span class="text-gray-700">{{ $student[0]->room->name ?? 'N/A' }}</span> 
                            (<span class="text-gray-700">{{ $student[0]->room->section ?? 'N/A' }}</span>)
                        </h2>
                            ...
                            <div class="sm:text-center">
                                ...
                                @if($studentMarks)
                                    <span class="inline-block px-3 py-1 rounded-full text-sm font-medium 
                                        ...
                                        {{ $studentMarks->subject_id }} → {{ $studentMarks->marks_obtained }} → ({{ $studentMarks->grade }})
                                    </span>
                                @else
