                        ...
                        <div class="bg-white border rounded-xl shadow-md hover:shadow-lg transition duration-300 p-5">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
                                ...
                                <div class="sm:text-center">
                                    <form action="{{ url('/submit-mark/'.$val->id) }}" method="POST" class="flex flex-col sm:flex-row gap-3 items-center justify-center">
                                        @csrf
                                        <input type="hidden" name="subject_id" value="{{ $val->id }}">

                                        <select name="class_id" 
                                            class="w-full sm:w-48 border border-gray-300 rounded-lg p-2 text-gray-900 
